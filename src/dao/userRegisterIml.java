...
public class userRegisterIml implements userRegister {
    ...
    public void register(userMessage userMessage) {
        ...
        String sql = "INSERT INTO `testconn`.`user` (`Userid`, `name`, `account`, `password`, `phone`, `idcard`) VALUES ('" + userMessage.UserId + "', '" + userMessage.Name + "', '" + userMessage.Account + "', '"+userMessage.Password+"', '"+userMessage.Phone+"', '"+userMessage.IdCard+"');";
